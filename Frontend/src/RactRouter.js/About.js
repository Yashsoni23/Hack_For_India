  ...
  return (
    ...
    <img src="./img1.1.jpg" alt="" srcset="" className='h-full w-full '/>
      ...
      <div className="h-screen max-sm:h-fit w-full flex justify-between max-sm:justify-center max-sm:flex-col gap-[5rem] px-[1rem]">
        <div className="w-[45%] pt-[16rem] ml-[6rem] max-sm:w-full max-sm:ml-0 max-sm:pt-[8rem] max-sm:px-[2rem]">
      ...
      {/* ------------ */}
      <div className="m-[3rem] mt-[12rem] mb-[6rem]">
        ...
        <div className="px-[6rem] w-full flex flex-col items-center gap-[4rem]">
          <div className="w-full flex max-sm:flex-col justify-between items-center gap-[4rem]">
            ...
            <div className=" w-[40rem] max-w-full">
              <h2 className="text-[2.2rem] text-primaryColor font-medium mb-[2rem]">Mission</h2>
