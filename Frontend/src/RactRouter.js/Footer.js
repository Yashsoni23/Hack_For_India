...
function Footer() {
  return (
    ...
    <footer class="bg-slate-100 text-black">
      <div class="mx-auto w-full  p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between max-sm:gap-[4rem]">
          <div class="pl-[2rem] mb-6 md:mb-0">
            <a href="https://flowbite.com/" class="flex items-center">
              <h1 className="text-[1.4rem] font-bold ">
                <span className="text-primaryColor">क</span>RM
              </h1>
            </a>
            <p className="w-[40rem] h-fit text-[1rem] max-sm:w-full ">
              we're committed to connecting skilled wage workers with clients in
              need of their expertise. Our platform simplifies the process of
              finding cash work opportunities or hiring reliable workers for
              quick tasks. We prioritize safety and trust, offering a secure
              environment where all workers undergo verification. Explore our
